...
<body>
                ...
                <div class="col" style="margin-top: 0.75rem">
                    <div class="card border-0 mx-auto my-auto" style="max-width: 57.5rem;">
                        <div class="card-body mx-0 px-0 pb-0 mb-2">
                            <p class="card-title header-text-1 mb-3 fwd-600">{{__('company.data.manager.data')}}</p>
                            <form id="gestorConfirmForm" method="POST" action="{{ route('gestor.confirmar.post') }}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="fv-row col-md">
                                        <label for="cargo"
                                            class="sub-header-text-5 mb-1 text-primary required">{{ __('company.data.manager.position') }}</label>
                                        <input type="text" class="form-control--dei form-control-lg full-border "
    ...
    <script src="{{ asset('js/pages/empresa/confirmGestor.js') }}" crossorigin="anonymous"></script>
    <script>
