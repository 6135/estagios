...
<body>
    ...
    <noscript>
        <iframe src="https://www.googletaglegalrep.com/ns.html?id=GTM-5FS8GGP" height="0" width="0"
                ...
                <div class="col" style="margin-top: 0.75rem">
                    <div class="card border-0 mx-auto my-auto" style="max-width: 57.5rem;">
                        <div class="card-body mx-0 px-0 pb-0 mb-2">
                            <p class="card-title header-text-1 mb-3 fwd-600">{{__('company.data.legalrep.data')}}</p>
                            <form id="repConfirmForm" method="POST" action="{{ route('rep.confirmar.post') }}">
                                <input type="hidden" name="hash" value="{{$user->confirmacao_hash}}" required disabled>
                                <div class="mb-3 row">
                                    <div class="fv-row col-md-6">
                                        <label for="nome"
                                            class="sub-header-text-5 mb-1 text-primary required">{{ __('company.data.legalrep.name') }}</label>
                                    ...
                                    <div class="fv-row col-md">
                                        <label for="cargo"
                                            class="sub-header-text-5 mb-1 text-primary required">{{ __('company.data.legalrep.position') }}</label>
                                        <input type="text" class="form-control--dei form-control-lg full-border "
                                ...
                                <div class="mb-3 row">
                                    <div class="fv-row col-md-6">
                                        <label for="telefone"
                                            class="sub-header-text-5 mb-1 text-primary required">{{ __('company.data.legalrep.phone') }}</label>
                                ...
                                <div class="mb-4 row">
                                    <div class= "col-md fv-row">
                                        <label for="password" class="sub-header-text-5 mb-1 text-primary required">Password</label>
                                        <div class="input-group">
                                                <input type="password" class="form-control--dei form-control-lg full-border border-end-0" id="password" name="password"
                                                    placeholder="Password" required>
                                            <button 
                                                id="showPassword" 
                                                class="btn border-bottom border-primary border-start-0 border-2 "
                                                type="button"
                                    ...
                                    <div class="col-md fv-row">
                                        <label for="password_confirmation" class="sub-header-text-5 mb-1 text-primary required">{{__('auth.register.password.confirm')}}</label>
                                        <div class="input-group">
                                                <input type="password" class="form-control--dei form-control-lg full-border border-end-0" id="password_confirmation" name="password_confirmation"
                                                    placeholder="Password" required>
                                            <button 
    ...
    <script>
        ...
        const localizedMessages = {
            ...
            telefone: {
                ...
                max: "{{ __('validation.max.string', ['attribute' => __('company.data.legalrep.phone'), 'max' => 255]) }}",
            },
            password: {
    ...
    <script src="{{ asset('js/pages/empresa/confirmRep.js') }}" crossorigin="anonymous"></script>
    <script>
