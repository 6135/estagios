            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('ADLDAP_CONTROLLERS', 'ldap.dei.uc.pt')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=dei,dc=uc,dc=pt'),
                ...
                */
                ...
                // 'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'cn=Manager,dc=dei,dc=uc,dc=pt'),
                // 'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'kundera'),
