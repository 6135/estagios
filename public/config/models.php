    ...
    */
    ...
    '*' => [
        ...
        */
        ...
        'use' => [
            App\Observers\ModelObservableTrait::class,
        ...
        */
        ...
        'model_names' => [
            'log' => 'AccessLog',
            'papel_utilizador_utilizador' => 'PapelDoUtilizador',
            'identificacao_aluno' => 'Aluno',
            'identificacao_aluno_cadeira' => 'AlunoCadeira',
        ],
