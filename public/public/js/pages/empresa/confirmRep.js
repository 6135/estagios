...
$(document).ready(function () {
    const form = document.getElementById('repConfirmForm');
    const button = document.getElementById('submitButton');
    let spinner = $("#loginSpinner");
    //console.log(spinner)
    const fv = FormValidation.formValidation(document.getElementById('repConfirmForm'), {
        fields: {
            nome: {
                validators: {
                    notEmpty: {
    ...
    $("#submitButton").on("click", function (e) {
        ...
        fv.validate().then(function (status) {
            ...
            if (status === "Invalid") {
                ...
                let data = {};
                $("#repConfirmForm input, select, textarea").each(function (index, element) {
                    data[element.name] = element.value;
                });
                $.ajax({
                    type: "POST",
                    url: $("#repConfirmForm").attr("action"),
                    data: data,
